...
if($lastInsertId)
{
echo "<script>alert('Reserva em analise!');</script>";
...
echo "<script>alert('Algo deu errado. Tente novamente!');</script>";
 ...
 echo "<script>alert('Carro ja reservado nessa data!');</script>"; 
 echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
}
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>R$<?php echo htmlentities($result->PricePerDay);?> </p>Por dia
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Detalhes </a></li>
          
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Especificações</a></li>
            </ul>
...
<tr>
<td>Sistema de travagem antibloqueio</td>
...
<tr>
<td>Travamento de portas eletrônico</td>
      ...
      <aside class="col-md-3">
          ...
          <form method="post">
            <div class="form-group">
              <label>Entrada:</label>
              <input type="date" class="form-control" name="fromdate" placeholder="De" required>
            </div>
            <div class="form-group">
              <label>Saída:</label>
              <input type="date" class="form-control" name="todate" placeholder="Para" required>
            </div>
            <div class="form-group">
          ...
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
                <input type="submit" class="btn"  name="submit" value="Reserve Agora">
              </div>
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Faça login para reservar</a>
