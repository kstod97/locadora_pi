...
<li>
    <h4 style="color:red">Reserva<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>De </b> <?php echo htmlentities($result->FromDate);?> <b>Até </b> <?php echo htmlentities($result->ToDate);?></p>
                  <div style="float: left"><p><b>Mensagem:</b> <?php echo htmlentities($result->message);?> </p></div>
                </div>
                <?php if($result->Status==1)
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Confirmada</a>
                           <div class="clearfix"></div>
        </div>

              <?php } else if($result->Status==2) { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelada</a>
            <div class="clearfix"></div>
        </div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Não confirmada ainda</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
