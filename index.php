...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Pago <span>Levou</span></h2>
      <p>Oferecemos aluguel de carros com preços acessíveis, flexibilidade e veículos bem conservados para sua comodidade e segurança. Escolha o modelo ideal e aproveite a liberdade de dirigir com conforto!</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Novo</a></li>
        </ul>
      </div>
...
<span class="price">R$<?php echo htmlentities($result->PricePerDay);?> /Dia</span> 
</div>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-calendar" aria-hidden="true"></i>2025</h2>
            <p>Novos no mercado</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <!--<h2>Avaliação dos <span>Clientes</span></h2>
    </div>
    <div class="row">
