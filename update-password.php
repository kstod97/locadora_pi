...
$error="Sua senha antiga está errada";  
}
}
...
{
alert("Nova senha e a senha de confirmação não são parecidas  !!");
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
               <input type="submit" value="Atualizar" name="updatepass" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
