...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/logo/admin.jpg" alt="image">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Informações</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>FEITO</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
