			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Administrar veículos</h2>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Deseja deletar?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
