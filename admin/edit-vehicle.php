...
<?php if($msg){?><div class="succWrap"><strong>FEITO</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
<?php 
$id=intval($_GET['id']);
...
<div class="form-group">
<label class="col-sm-2 control-label">Preço por dia(em R$)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Combústivel<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Porta malas (em bagagem)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Editar</a>
</div>
<div class="col-sm-4">
Imagem 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Editar</a>
<?php } ?>
</div>
...
<label for="inlineCheckbox2"> Travamento de portas eletrônico </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Sistema de travagem antibloqueio </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Airbag do passageiro </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Vidros elétricos </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Player para CD </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Bancos de couro </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Salvar</button>
												</div>
											</div>
