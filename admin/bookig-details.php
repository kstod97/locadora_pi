...
{				?>	
	<h3 style="text-align:center; color:red">#<?php echo htmlentities($result->BookingNumber);?> Detalhes </h3>

		<tr>
											<th colspan="4" style="text-align:center;color:blue">Usúario</th>
										</tr>
										<tr>
											<th>Reserva</th>
										...
										<tr>
											<th colspan="4" style="text-align:center;color:blue">Reserva</th>
										</tr>
											<tr>											
											<th>Carro</th>
...
if($result->Status==0)
{
echo htmlentities('Não confirmado ainda');
...
echo htmlentities('Confirmado');
 	...
 	echo htmlentities('Cancelado');
				...
				<a href="bookig-details.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Deseja confirmar essa reserva?')" class="btn btn-primary"> Confirmar reserva</a> 

<a href="bookig-details.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Deseja cancelar essa reserva?')" class="btn btn-danger"> Cancelar reserva</a>
</td>
</tr>
<?php } ?>
										<?php $cnt=$cnt+1; }} ?>
								...
								<form method="post">
	   <input name="Submit2" type="submit" class="txtbox4" value="Comprovante" onClick="return f3();" style="cursor: pointer;"  />
	</form>
