...
{
$error="Algo de errado. Tente Novamente";
}
...
<?php if($error){?><div class="errorWrap"><strong>ERRO</strong>:<?php echo htmlentities($error); ?> </div><?php } 
				else if($msg){?><div class="succWrap"><strong>FEITO</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>

									<div class="panel-body">
<form method="post" class="form-horizontal" enctype="multipart/form-data">
<div class="form-group">
<label class="col-sm-2 control-label">Veículo<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="powerdoorlocks"> Travamento de portas eletrônico </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="antilockbrakingsys" name="antilockbrakingsys" value="1">
<label for="antilockbrakingsys"> Sistema de travagem antibloqueio </label>
</div></div>
<div class="checkbox checkbox-inline">
...
<label for="passengerairbag"> Airbag do passageiro </label>
</div></div>
<div class="checkbox checkbox-inline">
...
<label for="cdplayer"> Player para CD </label>
</div>
</div>
<div class="col-sm-3">
